...
the server properties. This time, we modify properties to disable the default
unicode support::
...
The non-unicode name remains encoded::
...
Customers child keys::
    ...
    >>> customers.keys()
    ['ou=customer1', 'ou=customer2', 'ou=n\xc3\xa4sty\\, customer', 'uid=binary']
...
Check set child immediately after init time::
    ...
    >>> tmp.keys()
    ['ou=customer1', 'ou=customer2', 'ou=n\xc3\xa4sty\\, customer',
...
Unfortunately, other objects than LDAPNode may not respect our use_unicode
flag:
...
Set default search scope to SUBTREE::
    ...
    'ou=n\xc3\xa4sty\\2C customer,ou=customers,dc=my-domain,dc=com',
...
Search with binary in attrlist::
    ...
    ('ou=n\xc3\xa4sty\\2C customer,ou=customers,dc=my-domain,dc=com', {}),
    ('ou=demo,dc=my-domain,dc=com', {}),
    ('uid=binary,ou=customers,dc=my-domain,dc=com', {'jpegPhoto': ['...']}),
    ('ou=customer3,ou=customers,dc=my-domain,dc=com', {}),
    ('cn=customer99,ou=customers,dc=my-domain,dc=com', {})]
